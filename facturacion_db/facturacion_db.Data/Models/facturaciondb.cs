...
{
    public partial class facturaciondb : DbContext
    {
        public facturaciondb()
        {
        }

        public facturaciondb(DbContextOptions<facturaciondb> options)
            : base(options)
        {
        }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseMySql("server=localhost;database=facturacion_db;user id=sa;password=123", x => x.ServerVersion("10.4.6-mariadb"));
            }
        }
